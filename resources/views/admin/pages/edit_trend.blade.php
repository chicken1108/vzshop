...
@section('title','Sửa bài viết xu hướng')
@section('main')
            ...
            <div class="section" id="detail-page">
                ...
                <div class="section-detail">
                    <form method="POST" action="" enctype="multipart/form-data">
                        ...
                        <input type="text" name="title" id="title" value="{{$detail_trend->trend_title}}">
                        <label for="desc">Mô tả</label>
                        <textarea name="desc" id="desc">{{$detail_trend->trend_desc}}</textarea>
                        <label for="desc">Nội dung</label>
                        <textarea name="content_txt" id="content_txt">{{$detail_trend->trend_content}}</textarea>
                        <label>Hình ảnh</label>
                        <div id="uploadFile">
                            <input type="file" name="img" onchange="changeImg(this);" id="img">
                            <img id="avatar" src="public/uploads/trend/{{$detail_trend->trend_image}}">
                        </div>
